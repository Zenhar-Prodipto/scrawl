...
class UserService:
    @classmethod
    def create_user(cls, username, email, password, first_name, last_name, profile_type='public', bio=None):
        """
    ...
    @classmethod
    def match_password(cls, user, password):
        return user.check_password(password)

    @classmethod
    def update_user(cls, user: User, validated_data: dict) -> User:
        """
    ...
    @classmethod
    def soft_delete_user(cls, user: User) -> User:
        try:
...
get_user_by_username = UserService.get_user_by_username
match_password = UserService.match_password
update_user = UserService.update_user
soft_delete_user = UserService.soft_delete_user
get_interests = UserService.get_interests
